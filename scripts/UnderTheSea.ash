...
// ─── POST ADVENTURE ───────────────────────────────────────────────────────────
    ...
    void post_adv() {
        ...
        // Not for high shiny, which forces the drops it needs and would rather
        // keep the turn. Falling-down drunk the next adventure fails anyway, so
        // there is nothing left to recover the item for.
